...
{
	class Terrain : SingletonGO<Terrain>
	{
		static Material material;
		static Mesh mesh;

		public Terrain() : base( "BasicField.terrain" )
		{
			InitializeAssets();
		...
		void InitializeAssets()
		{
			...
			material.DiffuseMap = new Texture2D( "grass01", "Assets/Textures/grass/grass01.jpg", TextureFormat.PRGBA_32bpp );
			material.NormalMap = new Texture2D( "grass01_n", "Assets/Textures/grass/grass01_n.jpg", TextureFormat.PRGBA_32bpp );
